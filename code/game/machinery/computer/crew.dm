...
/datum/crewmonitor
	...
	var/list/jobs = list(
		...
		JOB_PARAMEDIC = 23,
		JOB_CORONER = 24,
		// JOB_ORDERLY = 25, // SKYRAT EDIT ADDITION // SPLURT REMOVAL, DEPT GUARDS.
		...
		JOB_ROBOTICIST = 32,
		JOB_GENETICIST = 33,
		// JOB_SCIENCE_GUARD = 34, // SKYRAT EDIT ADDITION // SPLURT REMOVAL, DEPT GUARDS.
		// 40-49: Engineering
		JOB_CHIEF_ENGINEER = 40,
		JOB_STATION_ENGINEER = 41,
		JOB_ATMOSPHERIC_TECHNICIAN = 42,
		// JOB_ENGINEERING_GUARD = 43, // SKYRAT EDIT ADDITION // SPLURT REMOVAL, DEPT GUARDS.
		...
		JOB_BITRUNNER = 53,
		// JOB_CUSTOMS_AGENT = 54, // SKYRAT EDIT ADDITION // SPLURT REMOVAL, DEPT GUARDS.
