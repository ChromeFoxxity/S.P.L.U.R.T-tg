/datum/dynamic_ruleset/midround/from_ghosts/lone_infiltrator
	...
	blacklisted_roles = list(
		...
		JOB_NT_TRN,
		JOB_BLUESHIELD,
		// JOB_ORDERLY, // SPLURT REMOVAL, DEPT GUARDS.
		JOB_BOUNCER,
		// JOB_CUSTOMS_AGENT, // SPLURT REMOVAL, DEPT GUARDS.
		// JOB_ENGINEERING_GUARD, // SPLURT REMOVAL, DEPT GUARDS.
		// JOB_SCIENCE_GUARD, // SPLURT REMOVAL, DEPT GUARDS.
	)
	min_antag_cap = 1
