/area/ocean
	...
	area_flags = VALID_TERRITORY | UNIQUE_AREA | FLORA_ALLOWED // SPLURT ADDITION
...
/area/ocean/trench
	area_flags = VALID_TERRITORY | UNIQUE_AREA | CAVES_ALLOWED | FLORA_ALLOWED | MOB_SPAWN_ALLOWED // SPLURT EDIT
	name = "The Trench"
