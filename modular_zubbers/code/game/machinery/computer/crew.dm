/datum/crewmonitor
	...
	jobs = list(
		...
		//Medical
		// JOB_ORDERLY = 301, // SPLURT REMOVAL, DEPT GUARDS.
		JOB_CHEMIST = 302,
		JOB_VIROLOGIST = 303,
		JOB_CORONER = 304,
		...
		//Science
		// JOB_SCIENCE_GUARD = 401, // SPLURT REMOVAL, DEPT GUARDS.
		JOB_ROBOTICIST = 402,
		JOB_GENETICIST = 403,
		JOB_SCIENTIST = 404, //Not found. ERPing in dorms.

		//Engineering
		// JOB_ENGINEERING_GUARD = 501, // SPLURT REMOVAL, DEPT GUARDS.
		JOB_ATMOSPHERIC_TECHNICIAN = 502,
		JOB_STATION_ENGINEER = 503,
		JOB_TELECOMMS_SPECIALIST = 504,

		//Cargo
		// JOB_CUSTOMS_AGENT = 601, // SPLURT REMOVAL, DEPT GUARDS.
		JOB_SHAFT_MINER = 602,
		JOB_BLACKSMITH = 603,
