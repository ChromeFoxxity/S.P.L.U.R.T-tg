...
/obj/machinery/computer/camera_advanced/ratvar
	...
	icon = 'modular_zzplurt/icons/obj/machines/computer.dmi'
	icon_screen = "ratvar1"
...
/obj/machinery/computer/camera_advanced/ratvar/process(seconds_per_tick)
	...
	if(SPT_PROB(7, seconds_per_tick))
		playsound(get_turf(src), 'modular_zzplurt/sound/machines/beep.ogg', 20, TRUE)

/obj/machinery/computer/camera_advanced/ratvar/CreateEye()
	. = ..()
	eyeobj = new(get_turf(src), src)
	eyeobj.icon = 'modular_zzplurt/icons/obj/clock_cult/clockwork_objects.dmi'
	eyeobj.icon_state = "belligerent_eye"
