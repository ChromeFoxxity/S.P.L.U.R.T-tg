...
/datum/scripture/slab/sentinels_compromise/apply_effects(mob/living/healed_mob)
	...
	//MMMMMM, CHUNKY
	var/total_damage = (healed_mob.getBruteLoss() + healed_mob.getFireLoss() + healed_mob.getOxyLoss() + healed_mob.getToxLoss()) * 0.6
	healed_mob.adjustStaminaLoss(-healed_mob.getStaminaLoss() * 0.6)
	...
	healed_mob.adjustToxLoss(-healed_mob.getToxLoss() * 0.6)
