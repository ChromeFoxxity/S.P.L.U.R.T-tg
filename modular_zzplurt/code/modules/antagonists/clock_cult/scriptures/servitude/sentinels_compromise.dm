...
/datum/scripture/slab/sentinels_compromise/apply_effects(mob/living/healed_mob)
	...
	//MMMMMM, CHUNKY
	var/total_damage = (healed_mob.get_brute_loss() + healed_mob.get_fire_loss() + healed_mob.get_oxy_loss() + healed_mob.get_tox_loss()) * 0.6
	healed_mob.adjust_stamina_loss(-healed_mob.get_stamina_loss() * 0.6)
	...
	healed_mob.adjust_tox_loss(-healed_mob.get_tox_loss() * 0.6)
