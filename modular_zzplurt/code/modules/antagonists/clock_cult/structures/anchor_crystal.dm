...
/obj/structure/destructible/clockwork/anchoring_crystal
	...
	break_sound = 'modular_zzplurt/sound/machines/clockcult/ark_damage.ogg'
...
/obj/structure/destructible/clockwork/anchoring_crystal/proc/on_update_overlays(atom/crystal, list/overlays)
	...
	var/mutable_appearance/shield_appearance = mutable_appearance('modular_zzplurt/icons/obj/clock_cult/clockwork_effects.dmi', \
